...
consume `funnypot/funnypot`, using its own existing honeypot pieces
...
`composer require funnypot/funnypot` then symlinks the package into
`vendor/funnypot/funnypot`. Laravel package auto-discovery picks up
