...
final class ProtocolTemplateSet
{
    ...
    {
        return self::fromFile(dirname(__DIR__, 2) . '/resources/compiled/funnypot-protocols.php');
    }
    ...
    {
        return isset($this->protocols[$id]) ? new ProtocolEmulator($this->protocols[$id]) : null;
    }
